...
class SNMPPlugin:
    ...
    oidPrefix = '1.3.6.1.4.1.17095'
    oidRelay1 = oidPrefix + '.3.2'
    oidRelay2 = oidPrefix + '.3.3'
    oidRelay3 = oidPrefix + '.3.4'
    oidRelay4 = oidPrefix + '.3.5'
    oidRelay5 = oidPrefix + '.3.6'
    oidRelay6 = oidPrefix + '.3.7'
    oidRelay7 = oidPrefix + '.3.8'
    oidRelay8 = oidPrefix + '.3.9'
